...
Ti.include('Colors.UI.js');

(function(){
    // var windowToAddThisStuffTo = Titanium.UI.currentWindow; 
    var windowToAddThisStuffTo = colorWindow;
    ...
    var colors = [
        ...
        '#66CCCC','#99CC99','#CCFF66', 
        '#FFFF33','#6600FF','#330000'
    ];
    ...
    //---------
    ExteriorHouseColors.prototype.changePrimaryColorOfInnerViews = function() {_.log('Put inner view Primary color change logic here...')};
    
    //---------
    // changePrimaryColorOfInnerViews is basically an abstract method intended to be implemented by the child...so they can color in the stuff inside of the main block view
    //      -- such as the window and door of the outside, and the window/trimming of the interior
    //---------
    ExteriorHouseColors.prototype.changePrimaryColorOfInnerViews = function() {_.log('Put inner view Trim color change logic here...')};
    ...
    var primaryColorSelectorShell = Ti.UI.createScrollView(
        DTH.UI.ColorCreate.getPrimaryColorViewOptions(colors.length));
    
    DTH.UI.ColorCreate.addColorSelectors(
        primaryColorSelectorShell, 
        getColorSelectorArrayWithSameOnClickCallback(colors, changePrimary)
    );
    ...
    var trimColorSelectorShell = Ti.UI.createScrollView(
        DTH.UI.ColorCreate.getTrimColorViewOptions(colors.length));
    
    DTH.UI.ColorCreate.addColorSelectors(
        trimColorSelectorShell, 
        getColorSelectorArrayWithSameOnClickCallback(colors, changeTrim)
    );
